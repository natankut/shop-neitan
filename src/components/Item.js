...
export default function Item(props) {
    ...
    return (
        ...
        <div className="card rounded-3 shadow p-1 m-1">
            ...
            <div className="card-body d-flex flex-column fw-bold">
                ...
                <div className="card-footer d-flex justify-content-between fw-bold">
                    ...
                    <button className="btn p-0"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-bag-plus" viewBox="0 0 16 16">
